  ...
  <div class="navbar-inner">
    ...
    <ul id="topMenu" class="nav pull-right">
	 ...
	 <a href="#login" role="button" data-toggle="modal" style="padding-right:0"><span class="btn btn-large btn-success">登录</span></a>
        ...
        <% } else {%>
        <li class=""> 
        <a href="#login" role="button" data-toggle="modal" style="padding-right:0"><span class="btn btn-large btn-success">退出</span></a>
        </li>
        <% }%>
    </ul>
  </div>
	...
	<div id="sidebar" class="span3">
		...
		<ul id="sideManu" class="nav nav-tabs nav-stacked">
			...
			<li class="subMenu open"><a> 电子产品</a>
				...
				<li><a href="products.jsp"><i class="icon-chevron-right"></i>电脑</a></li>
				<li><a href="products.jsp"><i class="icon-chevron-right"></i>数码相机</a></li>
				<li><a href="products.jsp"><i class="icon-chevron-right"></i>其他</a></li>
				</ul>
			</li>
...
<!-- Sidebar end=============================================== -->
	<div class="span9">
    <ul class="breadcrumb">
		<li><a href="index.jsp">旧物新用</a> <span class="divider">/</span></li>
		<li class="active">购物车</li>
    </ul>
	<h3> 购物车[ <small>3 件商品</small>]<a href="products.jsp" class="btn btn-large pull-right"><i class="icon-arrow-left"></i> 继续购物 </a></h3>	
	 <% if(session.getAttribute("inputUname")==null) { %>
        <hr class="soft"/>
		 ...
		 <td>
			<form class="form-horizontal">
				<div class="control-group">
				  ...
				  <div class="controls">
					<input type="text" id="inputUname" placeholder="用户名">
				  </div>
				</div>
				<div class="control-group">
				  <label class="control-label" for="inputPwd">密码</label>
				  <div class="controls">
					<input type="password" id="inputPwd" placeholder="密码">
				  </div>
				</div>
				<div class="control-group">
				  <div class="controls">
	...
	<table class="table table-bordered">
		 ...
		 <tr>
                ...
                <tr>
                  <td colspan="6" style="text-align:right"><strong>需支付</strong></td>
