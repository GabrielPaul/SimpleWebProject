...
<!-- 
	...
	degreeOld:<s:property value="goods_detail.degreeOld"/><br/>
	addTime:<s:property value="goods_detail.addTime"/><br/>
	onSellTime:<s:property value="goods_detail.onSellTime"/><br/>
	price:<s:property value="goods_detail.price"/><br/>
...
<div id="mainBody">
	...
	<div class="row">	  
            ...
            <a href=<s:property value="detailsGoodsPic"/> title="full picture of <s:property value="goods_detail.goodsName"/>">
			...
			<div class="span6">
				<h3>商品名称:<s:property value="goods_detail.goodsName"/></h3>
				<hr class="soft"/>
				...
				<hr class="soft clr"/>
				<p>
				商品描述:<s:property value="goods_detail.description"/>
				
				</p>
				<a class="btn btn-small pull-right" href="#detail">更多详细</a>
				<br class="clr"/>
            ...
            <div id="myTabContent" class="tab-content">
			  ...
			  <h4>商品详细信息</h4>
				...
				<tbody>		
				<tr class="techSpecRow"><td class="techSpecTD1">商品名称：<s:property value="goods_detail.goodsName"/></td><td class="techSpecTD2"></td></tr>
				<tr class="techSpecRow"><td class="techSpecTD1">颜色：</td><td class="techSpecTD2"></td></tr>
				<tr class="techSpecRow"><td class="techSpecTD1">尺寸：</td><td class="techSpecTD2"> </td></tr>
