<%@ page pageEncoding="GBK" language="java" import="java.sql.*" errorPage="" pageEncoding="UTF-8"%>
<!DOCTYPE html>
			...
			<form class="form-horizontal loginFrm">
			  <div class="control-group">								
				&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                ...
                                <a href="login.html">&nbsp; &nbsp; 还没有账号，需要注册？</a>
...
<!-- Sidebar end=============================================== -->
	...
	<div class="row">
		<div class="span4">
			<div class="well">
			<h5>创建您的账号</h5><br/>
			输入您的用户名（不少于6位，不大于12位）<br/><br/><br/>
			<form action="register.jsp" method="post">
			  <div class="control-group">
				<label class="control-label" for="inputRname">用户名</label>
				<div class="controls">
				  <input class="span3"  type="text" id="inputRname" placeholder="用户名" name="inputRname">
				</div>
			  </div>
			  <div class="controls">
		...
		<div class="span4">
			...
			<h5>已经有账号？</h5>
			  ...
			  <div class="control-group">
				...
				<div class="controls">
				  <input class="span3"  type="text" id="inputUname" name="inputUname" placeholder="用户名">
				</div>
			  </div>
			  <div class="control-group">
				<label class="control-label" for="inputPwd"  >密码</label>
				<div class="controls">
				  <input type="password" class="span3"  id="inputPwd" name="inputPwd" placeholder="密码">
				</div>
			  </div>
			  <div class="control-group">
				<div class="controls">
				  <button type="submit" class="btn" name="login"  >登录</button> <a href="forgetpass.html">&nbsp;&nbsp;&nbsp;&nbsp;忘记密码?</a>
				</div>
			  </div>
			</form>
		</div>
