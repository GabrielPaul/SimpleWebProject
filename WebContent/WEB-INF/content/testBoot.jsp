...
<title>Struts2 Bootstrap Plugin Showcase - <s:text
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-9">
				...
				<p>Struts2 Bootstrap Plugin Examples for the head tag and the
					form elements.</p>
				...
				<s:form action="index" enctype="multipart/form-data"
					...
					<s:textfield label="Name" name="name" cssClass="input-sm"
					...
					<s:select tooltip="Choose Your Favourite Color"
						label="Favorite Color" elementCssClass="col-sm-4"
					...
					<s:radio tooltip="Radio Buttons with inline position"
						...
						list="{'Wes', 'Patrick', 'Jason', 'Jay', 'Toby', 'Rene'}"
						name="bestFriendInline" cssErrorClass="foo" />
					...
					<s:inputtransferselect
						...
						label="Favourite Cartoons Characters"
						name="inputLeftSideCartoonCharacters" addLabel="Add element"
						removeLabel="Remove element" removeAllLabel="Remove all elements"
						upLabel="Move up" downLabel="Move down" leftTitle="Add Character"
					...
					<s:textarea label="Your Thougths" name="thoughts"
						cssClass="input-xxlarge" tooltip="Enter your thoughts here" />
